...
for deletion messages, and a class attribute for tracking
the number of instances and the print symbol, and a static method
for comparing rectangles based on area.
"""
